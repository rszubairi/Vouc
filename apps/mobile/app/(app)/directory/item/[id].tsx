            ...
            comments.map((c) => (
              <View key={c._id} style={styles.commentRow}>
                <Avatar
                  ...
                  placeholderStyle={[styles.commentAvatar, styles.commentAvatarPlaceholder]}
                  textStyle={styles.commentAvatarInitial}
                />
...
const styles = StyleSheet.create({
  ...
  commentAvatarPlaceholder: { backgroundColor: "#1C1B18", alignItems: "center", justifyContent: "center" },
  commentAvatarInitial: { color: "#F2650C", fontSize: 12, fontWeight: "700" },
